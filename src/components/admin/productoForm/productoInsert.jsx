...
const ProductoUpdate = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (categs[0]) {
        const idcateg = categs[0].idcateg;
        setArr_subcategs(
          await APIConsultas.subCategorias.GET_XID(idcateg, true)
        );
      }
    };
            ...
            <div className="cont-inps w-full">
              ...
              <div className="grid grid-cols-1 gap-5 md:gap-8 mt-5">
                <div className="grid grid-cols-1">
                  ...
                  <textarea
                    className="px-3 py-2 h-10 rounded-[20px] border-2 border-secondary mt-1"
                    id="descripBreve"
                    name="descripBreve"
                    onChange={onChange}
